# Forensic Baseline — floor-cross-leg
- name: Cross-Legged
...
```json
{
  "head": {
    ...
    "yaw_deg": 0,
    "roll_deg": -4,
    "description": "Head pitch -8° (+: forward/down), roll -4° (+: tilt to figure's right). Yaw not modeled by renderer (low confidence)."
  },
  "torso": {
    "flexion_deg": -8,
  ...
  "left_leg": {
    ...
    "foot_forward_deg": -91.1,
    "thigh_length": 0.43,
    "shank_length": 0.42,
    "description": "Left leg: thigh forward ~80° (hip flexion); knee ~right-angle (109°)."
  },
  "right_leg": {
    "hip_flexion_deg": 80,
    "hip_abduction_deg": -69.6,
    ...
    "thigh_length": 0.43,
    "shank_length": 0.42,
    "description": "Right leg: thigh forward ~80° (hip flexion); knee ~right-angle (109°)."
  },
  "contacts": [
    {
      "body": "leftFoot",
...
- Head: Head pitch -8° (+: forward/down), roll -4° (+: tilt to figure's right). Yaw not modeled by renderer (low confidence).
...
- L leg: Left leg: thigh forward ~80° (hip flexion); knee ~right-angle (109°).
- R leg: Right leg: thigh forward ~80° (hip flexion); knee ~right-angle (109°).
